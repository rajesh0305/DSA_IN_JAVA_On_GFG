<h2><a href="https://www.geeksforgeeks.org/problems/maximum-and-value-1587115620/1?page=2&category=Bit%20Magic&sortBy=submissions">Maximum AND Value</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr</strong>[] of <strong>N</strong> positive elements. The task is to find the <em>Maximum</em> <strong>AND</strong> <em>Value</em> generated by any pair(<strong>arr<sub>i, </sub>arr<sub>j</sub></strong>) from the array such that&nbsp;<strong>i != j</strong>.<br>
