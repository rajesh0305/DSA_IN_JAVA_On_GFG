...
class Solution {
   ...
   // static long lastindex(int x[],int L,int H,int b){
    //     long res=L;
    //     while(L<=H){
    //             int mid=(L+H)/2;
    //             double a= Math.pow(x[mid],b);
    //             double c=Math.pow(b,x[mid]);
    //             if(a>c){
    //                 res=mid+1;
    //                 L=mid+1;
    //             }
    ...
    //         int j=0;
    //         while(j<M){
    //             double a=Math.pow(x[j],y[i]);
    //             double b=Math.pow(y[i],x[j]);
    //             if(a>b){
    //                 count +=lastindex(x,j+1,M-1,y[i])-j;
    //                 j=M;
    //             }
    //             else{
    //                 j++;
