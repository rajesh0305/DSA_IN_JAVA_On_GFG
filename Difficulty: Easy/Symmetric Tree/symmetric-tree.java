...
class GfG
{
    public static boolean isSymmetric(Node t1,Node t2){
       ...
       if(t1==null && t2==null){
        ...
        return ((t1.data==t2.data)&&isSymmetric(t1.left,t2.right)&&isSymmetric(t2.left,t1.right));
    }
...
// Return ((node->data == node2->data) && (isSymm (node1->left, node2->right) 
// && (isSymm (node1->right, node2->left)
   ...
   static boolean  symetric(Node left,Node right){
        if(left==null&&right==null)return true;
        if((left!=null&&right==null)||(left==null&&right!=null))return false;
        return left.data==right.data && symetric(left.left,right.right)&&symetric(left.right,right.left);
    }
}